...
import { Text, View, StyleSheet, SafeAreaView, ScrollView, Switch, Button } from 'react-native';
...
function AccountPage({ navigation, route }) {
    ...
    return(
        <SafeAreaView style={styles.container}>
            <Text style={{fontSize: 30, textAlign: 'center', paddingBottom: 5, paddingTop: 5}}>Account</Text>
